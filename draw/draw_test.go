...
func hgradRed(alpha int) draw.Image {
	m := image.NewRGBA(image.Rect(0, 0, 16, 16))
	for y := 0; y < 16; y++ {
		for x := 0; x < 16; x++ {
...
func gradYellow(alpha int) draw.Image {
	m := image.NewRGBA(image.Rect(0, 0, 16, 16))
	for y := 0; y < 16; y++ {
		for x := 0; x < 16; x++ {
...
var drawTests = []drawTest{
	...
	{"gray", vgradGray(), fillAlpha(255), draw.Over, color.RGBA{136, 136, 136, 255}},
	{"graySrc", vgradGray(), fillAlpha(255), draw.Src, color.RGBA{136, 136, 136, 255}},
	{"grayAlpha", vgradGray(), fillAlpha(192), draw.Over, color.RGBA{136, 102, 102, 255}},
	{"grayAlphaSrc", vgradGray(), fillAlpha(192), draw.Src, color.RGBA{102, 102, 102, 192}},
	{"grayNil", vgradGray(), nil, draw.Over, color.RGBA{136, 136, 136, 255}},
	{"grayNilSrc", vgradGray(), nil, draw.Src, color.RGBA{136, 136, 136, 255}},
	...
	{"cmyk", vgradMagenta(), fillAlpha(255), draw.Over, color.RGBA{192, 89, 192, 255}},
	{"cmykSrc", vgradMagenta(), fillAlpha(255), draw.Src, color.RGBA{192, 89, 192, 255}},
	{"cmykAlpha", vgradMagenta(), fillAlpha(192), draw.Over, color.RGBA{178, 67, 145, 255}},
	{"cmykAlphaSrc", vgradMagenta(), fillAlpha(192), draw.Src, color.RGBA{145, 67, 145, 192}},
	{"cmykNil", vgradMagenta(), nil, draw.Over, color.RGBA{192, 89, 192, 255}},
	{"cmykNilSrc", vgradMagenta(), nil, draw.Src, color.RGBA{192, 89, 192, 255}},
...
func TestNonZeroSrcPt(t *testing.T) {
	...
	draw.Draw(a, image.Rect(0, 0, 1, 1), b, image.Pt(1, 1), draw.Over)
...
func TestPaletted(t *testing.T) {
	...
	drawers := map[string]draw.Drawer{
		"src":             draw.Src,
		"floyd-steinberg": draw.FloydSteinberg,
	}
